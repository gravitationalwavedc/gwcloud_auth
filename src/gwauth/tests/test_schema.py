...
class TestQueriesSchema(AuthTestCase):
    ...
    def test_user_details(self):
        ...
        self.assertEqual(run_query().data["gwclouduser"], None)
    ...
    def test_username_filter(self):
        ...
        self.assertEqual(run_query("bil").data["usernameFilter"], None)
        ...
        self.client.authenticate(
            token=self.get_token(self.buffy, settings.AUTH_SERVICE_JWT_SECRET)
        )
    ...
    def test_username_lookup(self):
        ...
        self.assertEqual(run_query(self.bill.id).data["usernameLookup"], None)
